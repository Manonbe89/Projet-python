...
#setters
    ...
    def _set_current_item(self, new_item) :
        self.current_item = new_item

    def _get_current_item(self) :
        return self.curent_item
